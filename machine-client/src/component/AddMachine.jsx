                  ...
                  <table className="min-w-full border border-gray-300">
                    <thead className="bg-gray-100">
                      <tr>
                        ...
                        <th className="px-4 py-2 border">Factory Name</th>
                        <th className="px-4 py-2 border">Machine Category</th>
                        <th className="px-4 py-2 border">Machine Group</th>
                        <th className="px-4 py-2 border">Machine Code</th>
