...
function TransferMachineList() {
  ...
  const flattenData = (machineList) => {
    return machineList.flatMap((m) => {
      ...
      return transfers.map((t, idx) => ({
        ...
        fromFactory: t.fromFactory, // ✅ use actual fromFactory
        toFactory: t.toFactory, // ✅ use actual toFactory
  ...
  const handleExportExcel = () => {
    ...
    XLSX.utils.book_append_sheet(workbook, worksheet, "Transferred Machines");
    XLSX.writeFile(workbook, "TransferredMachines.xlsx");
  };
        ...
        <div className="bg-white p-8 rounded-2xl shadow-lg border border-gray-100">
          ...
          {loading ? (
            <div className="text-center text-gray-500 py-6 animate-pulse">
              Loading transferred machines...
            </div>
          ) : paginatedRows.length === 0 ? (
            <div className="text-center text-gray-500 py-6">
              No transferred machines found 🚫
            </div>
          ) : (
            <>
              {/* Table */}
...
export default TransferMachineList;
