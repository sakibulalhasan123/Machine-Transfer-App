...
import useNotifications from "../component/Notifications.jsx";
...
function Navbar() {
  ...
  // ==========================
  const { notifications, unseenCount, markSeen, markAllSeen } =
          ...
          {user && (
            <>
              ...
              <div className="relative">
                ...
                {showNotifDropdown && (
                  <div className="absolute right-0 mt-3 w-80 bg-white text-gray-800 rounded-lg shadow-lg max-h-64 overflow-y-auto z-50">
                    ...
                    {notifications.map((n) => (
                      <div
                        key={n._id}
                        className={`px-4 py-2 border-b border-gray-200 hover:bg-gray-50 text-sm cursor-pointer ${
                          n.seenBy?.includes(user._id) ? "" : "bg-indigo-50"
                        }`}
                    ...
                    {group.children
                      ...
                      .map((link) => (
                        <li key={link.to}>
                          <Link
                            to={link.to}
                            className={`block w-full text-center px-4 py-2 text-gray-800 no-underline rounded-md transition duration-200 hover:bg-indigo-50 hover:text-indigo-700 ${
                              location.pathname === link.to
                                ? "font-semibold text-indigo-600"
                                : ""
                            }`}
